...
// Sample data - in production this would come from Neon DB
const sampleContacts: Contact[] = [
  {
    id: 1,
    businessName: "Paradise Driveways And Patios",
    email: "paradisedandp@hotmail.com",
    website: "https://www.paradise-drivewaysandpatios.co.uk/",
    websiteGenerator: "Wix.com Website Builder",
    businessType: "paving contractor",
    city: "Wembley",
    initialContact: "Yes (2026-02-03)",
    followUp: "No",
    notes: ""
  },
  {
    id: 2,
    businessName: "Driveways Derby",
    email: "info@drivewaysderby.org.uk",
    website: "https://www.drivewaysderby.org.uk/",
    websiteGenerator: null,
    businessType: "paving contractor",
    city: "Derby",
    initialContact: "Yes (2026-02-03)",
    followUp: "No",
  ...
  {
    id: 3,
    businessName: "Vertiworks Services",
    email: "jacob@vertiworks.uk",
    website: "https://www.vertiworks.uk/",
    websiteGenerator: "Wix.com Website Builder",
    businessType: "driveway",
    city: "Nottingham",
    initialContact: "Yes (2026-02-03)",
    followUp: "No",
    notes: ""
  ...
  {
    id: 4,
    businessName: "Stardust Cleaning Services",
    email: "sales@stardustcleaning.co.uk",
    website: "https://stardustcleaning.co.uk/",
    websiteGenerator: "WordPress 6.9",
    businessType: "driveway",
    city: "Nottingham",
    initialContact: "Yes (2026-02-03)",
    followUp: "No",
  ...
  {
    id: 5,
    businessName: "Wollaton Gates And Fabrication",
    email: "wollatongatesandfabs@btinternet.com",
    website: "http://www.wollatongatesandfabrications.co.uk/",
    websiteGenerator: "Wix.com Website Builder",
    businessType: "driveway",
    city: "Nottingham",
    initialContact: "Yes (2026-02-03)",
  ...
  },
  {
    id: 6,
    businessName: "Projet",
    email: "joe@projetltd.co.uk",
    website: "https://projetltd.co.uk/",
    websiteGenerator: "WordPress 5.8.3",
    businessType: "driveway",
    city: "Nottingham",
    initialContact: "Yes (2026-02-05)",
    followUp: "No",
    notes: ""
  },
  {
    id: 7,
    businessName: "Chelsea Contractors",
    email: "chelsea@chelseacontractors.com",
    website: "https://www.chelseacontractors.com/",
    websiteGenerator: "Redux 4.5.9",
    businessType: "driveway",
    city: "London",
    initialContact: "No",
    followUp: "No",
...
export default function Home() {
  ...
  const cities = [...new Set(sampleContacts.map(c => c.city).filter(Boolean))] as string[]
    ...
    <div className="min-h-screen bg-slate-50">
      <header className="bg-white shadow-sm border-b border-slate-200 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-4">
          ...
          <p className="text-sm text-slate-500">{sampleContacts.length} contacts in database</p>
        </div>
      </header>
